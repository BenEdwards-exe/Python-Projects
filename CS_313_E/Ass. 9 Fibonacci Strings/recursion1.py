...
def countX(str):
    if "x" not in str:
        ...
        return 1 + countX(str.split("x", 1)[1])
...
def countHi(str):
    if "hi" not in str:
        ...
        return 1 + countHi(str.split("hi", 1)[1])
...
def changeXY(str):
    if "x" not in str:
        ...
        return changeXY( str.split("x",1)[0] + "y" + str.split("x",1)[1] )
...
def changePi(str):
    if "pi" not in str:
        ...
        return changePi( str.split("pi",1)[0] + "3.14" + str.split("pi",1)[1] )
...
def noX(str):
    if "x" not in str:
        ...
        return noX( str.split("x",1)[0] + str.split("x",1)[1] )
