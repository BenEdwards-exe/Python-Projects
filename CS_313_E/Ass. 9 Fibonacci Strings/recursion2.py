...
def split53Helper(nums, currentIndex, mul5_sum, mul3_sum):
    if (currentIndex >= len(nums)):
        return (mul5_sum == mul3_sum)
    elif (nums[currentIndex] % 5 == 0):
        return split53Helper(nums, currentIndex + 1, mul5_sum + nums[currentIndex], mul3_sum)
    elif (nums[currentIndex] % 3 == 0):
        return split53Helper(nums, currentIndex + 1, mul5_sum, mul3_sum + nums[currentIndex])
    else:
        return split53Helper(nums, currentIndex + 1, mul5_sum + nums[currentIndex], mul3_sum) or split53Helper(nums, currentIndex + 1, mul5_sum, mul3_sum + nums[currentIndex])    
